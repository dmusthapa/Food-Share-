...
public class LoginPage extends JFrame {
    private static final Color INK = new Color(31, 19, 22);
    private static final Color MUTED = new Color(108, 82, 86);
    private static final Color TEAL = new Color(217, 45, 45);
    private static final Color CORAL = new Color(193, 35, 35);
    private static final Color FIELD = new Color(252, 247, 247);
    private static final Color SOFT = new Color(255, 238, 238);
    ...
    private JPanel createLoginCard() {
        ...
        brandRow.add(new BrandBadge(26));
        JLabel brand = new JLabel("FOOD SHARE");
        brand.setFont(new Font("SansSerif", Font.BOLD, 14));
        brand.setForeground(CORAL);
        brandRow.add(brand);
        heading.add(brandRow, BorderLayout.NORTH);
        ...
        JLabel prompt = new JLabel("New to Food Share?");
    ...
    private static class BrandBadge extends JPanel {
        ...
        protected void paintComponent(Graphics graphics) {
            ...
            pen.setPaint(new GradientPaint(0, 0, new Color(217, 45, 45), size, size, new Color(193, 35, 35)));
            pen.fillRoundRect(0, 0, size, size, 10, 10);
            pen.setColor(new Color(255, 255, 255, 210));
            pen.fillRoundRect(7, 7, size - 14, size - 14, 8, 8);
            pen.setColor(new Color(217, 45, 45));
            pen.fillRoundRect(9, 9, size - 18, size - 18, 7, 7);
            pen.setColor(Color.WHITE);
            pen.fillOval(size / 2 - 3, size / 2 - 9, 6, 18);
            pen.drawLine(size / 2 - 8, size / 2 + 5, size / 2 + 8, size / 2 + 5);
            pen.drawLine(size / 2 - 8, size / 2 + 10, size / 2 + 8, size / 2 + 10);
            pen.dispose();
        }
    }
    ...
    private static class GradientPanel extends JPanel {
        ...
        protected void paintComponent(Graphics graphics) {
            ...
            pen.setPaint(new GradientPaint(0, 0, SOFT, getWidth(), getHeight(), new Color(255, 244, 244)));
            pen.fillRect(0, 0, getWidth(), getHeight());
            pen.setColor(new Color(217, 45, 45, 30));
            pen.fillOval(-120, getHeight() - 200, 420, 420);
            pen.setColor(new Color(193, 35, 35, 24));
            pen.fillOval(getWidth() - 200, -130, 360, 360);
            pen.dispose();
        }
    }
